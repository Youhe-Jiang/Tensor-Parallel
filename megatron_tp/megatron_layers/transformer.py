...
class ParallelMLP(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method, act_func = 'gelu', bias = True, dropout_prob = 0.0):
    ...
    def forward(self, hidden_states):
        ...
        if not self.bias:
            ...
            if self.act_func == 'gelu' and self.bias_gelu_fusion:
...
class ParallelAttention(MegatronModule):
    ...
    def __init__(self, init_method,
                 output_layer_init_method, layer_number=1,
